 ...
 *         &lt;element name="CodiEmpr" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
...
@XmlRootElement(name = "ActualizaEstadoDoc")
public class ActualizaEstadoDoc {

    protected String ruc;
    @XmlElement(name = "CodiEmpr")
    protected int codiEmpr;
     ...
     * 
     */
    public void setCodiEmpr(int value) {
        this.codiEmpr = value;
    }
