 ...
 * the License.
 */
package com.farenet.nodo.maestro.api.util.hibernate.user.types;
...
/**
 * A {@link UserType} that persists objects as JSON.
 * <p>
 * Unlike the default JPA object mapping, {@code JSONUserType} can also be used
 ...
 */
public class JSONUserType extends CollectionUserType implements
    ParameterizedType {
